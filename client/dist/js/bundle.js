...
var _Login = __webpack_require__("./client/src/components/TOTP/Login.js");
...
/***/ "./client/src/components/TOTP/Login.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Login = function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function renderSupportLink() {
      ...
      return _react2.default.createElement(
        'a',
        { href: method.supportLink, target: '_blank', rel: 'noopener noreferrer' },
    ...
    value: function renderVerifyForm() {
      ...
      var formGroupClasses = (0, _classnames2.default)('mfa-totp__validate-left form-group', {
        'has-error': !!error
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            i18n._t('TOTPLogin.VERIFY', 'Use verification code from your authenticator app. '),
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'mfa-totp__container mfa-totp__container--login' },
...
Login.propTypes = {
  onCompleteLogin: _propTypes2.default.func.isRequired,
...
var Register = function (_Component) {
  ...
  _createClass(Register, [{
    ...
    value: function renderScanCodeScreen() {
      ...
      var formattedCode = (0, _formatCode.formatCode)(code);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          i18n._t('TOTPRegister.INTRO', 'Use an authentication app such as Google Authenticator to scan the following code. '),
          this.renderSupportLink()
        ),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'mfa-totp__scan-middle' },
            i18n._t('TOTPRegister.OR', 'Or')
          ),
          _react2.default.createElement(
            'div',
            { className: 'mfa-totp__scan-right' },
            _react2.default.createElement(
              'p',
              null,
            ...
            _react2.default.createElement(
              'p',
              { className: 'mfa-totp__manual-code' },
              formattedCode
            )
          )
        )
    ...
    value: function renderValidateCodeScreen() {
      ...
      var _props2 = this.props,
          TOTPLoginComponent = _props2.TOTPLoginComponent,
          onCompleteRegistration = _props2.onCompleteRegistration;
      ...
      var loginProps = _extends({}, this.props, {
        onCompleteLogin: onCompleteRegistration,
        onCompleteRegistration: null
      });

      return _react2.default.createElement(TOTPLoginComponent, loginProps);
    }
  }, {
    key: 'render',
    value: function render() {
...
Register.propTypes = {
  ...
  TOTPLoginComponent: _propTypes2.default.oneOfType([_propTypes2.default.node, _propTypes2.default.func]).isRequired
};

exports.default = (0, _Injector.inject)(['TOTPLogin'], function (TOTPLoginComponent) {
  return {
    TOTPLoginComponent: TOTPLoginComponent
  };
}, function (_ref) {
  var contextKey = _ref.contextKey;
  return 'MFA.Register.' + contextKey;
})(Register);
