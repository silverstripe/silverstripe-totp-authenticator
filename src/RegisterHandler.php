...
class RegisterHandler implements RegisterHandlerInterface
{
    ...
    /**
     * Get an instance of the TOTP handler service
     *
    ...
    /**
     * Gets the encryption key to use from environment variables. This is generated by default on SilverStripe Platform
     * and the Common Web Platform, but can be defined as a custom value if required.
     *
     * @return string
     * @throws AuthenticationFailedException
     */
    ...
    {
        $key = Environment::getEnv('SS_MFA_SECRET_KEY');
        if (empty($key)) {
