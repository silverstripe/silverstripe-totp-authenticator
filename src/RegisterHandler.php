...
class RegisterHandler implements RegisterHandlerInterface
{
     ...
     * @var string
     */
    private static $user_help_link = 'https://userhelp.silverstripe.org/en/5/optional_features/multi-factor_authentication/user_manual/using_authenticator_apps/'; // phpcs:ignore
